...
<text x="81.28" y="-60.96" size="1.778" layer="94">Current Event Workshop</text>
...
<text x="35.56" y="-81.28" size="1.778" layer="94">Simple amplifier operation. As R1 is adjusted test point 2
voltage goes from the supply rail toward ground as the
transistor is turned on. With alternative base and collector
resistors compared to the previous circuit there is 
